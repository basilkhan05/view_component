...
Sandbox::Application.routes.draw do
  ...
  get :controller_inherited_inline, to: "integration_examples#controller_inherited_inline"
  get :controller_namespaced_inherited_inline, to: "integration_examples#controller_namespaced_inherited_inline"
